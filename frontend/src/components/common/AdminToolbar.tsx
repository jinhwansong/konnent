  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex w-full flex-col gap-3 lg:flex-1" data-slot="toolbar-filters">
          {filters}
        </div>
        {actions && (
          <div className="flex w-full justify-end gap-3 lg:w-auto" data-slot="toolbar-actions">
            {actions}
          </div>
        )}
      </div>
