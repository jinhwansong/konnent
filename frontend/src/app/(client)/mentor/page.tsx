    ...
    <section>
      <article className="relative">
        <div className="absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2">
          <h4 className="mb-4 text-center text-2xl leading-[1.3] font-bold text-[var(--text-bold)]">
            지식 공유의 새로운 길,
            <br /> 1:1 맞춤 멘토링을 시작하세요
          </h4>
          <p className="text-center text-lg leading-[1.4]">
        ...
        <ul className="grid grid-cols-2 gap-4">
          {REASON_OPTIONS.map((reasons, i) => (
            ...
            >
              ...
              <p className="text-sm leading-[1.4]">{reasons.content}</p>
            </li>
          ))}
        </ul>
      </article>
      <article className="mx-auto mb-16 md:w-[768px] lg:w-[1200px]">
        ...
        {FAQ_OPTIONS.map((faqs) => (
          <button
            ...
            className="mt-5 w-full rounded-[1rem] bg-[var(--primary-sub02)] p-7 text-left"
          >
            <details
            ...
            >
              ...
              <p className="mt-3 text-sm leading-[1.4]">{faqs.answer}</p>
            </details>
          </button>
        ))}
      </article>
